...
export const user = {name : "Ebenezer"}
export const dashboardStats = {
  totalUsers: 12450,
  UsersJoined: {currentMonth:218, lastMonth:165},
  totalTrips: 3230,
  tripsCreated: {currentMonth:175, lastMonth:214},
  userRole: {total:63, currentMonth:30, lastMonth:18},
}
